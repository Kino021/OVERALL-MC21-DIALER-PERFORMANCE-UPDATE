...
if uploaded_file is not None:
    ...
    if df.empty:
        ...
        def calculate_combined_summary(df):
            ...
            for cycle, group in df.groupby('Service No.'):  # Grouping by Cycle (Service No.)
        ...
        st.write("## Overall Combined Summary Table (Grouped by Cycle)")
        combined_summary_table = calculate_combined_summary(df)
        st.write(combined_summary_table, container_width=True)

        # Overall Predictive Summary Table (Grouped by Cycle)
        def calculate_predictive_summary(df):
            ...
            for cycle, group in df_filtered.groupby('Service No.'):  # Grouping by Cycle (Service No.)
        ...
        st.write("## Overall Predictive Summary Table (Grouped by Cycle)")
        overall_predictive_table = calculate_predictive_summary(df)
        st.write(overall_predictive_table)

        # Per Cycle Predictive Summary Table (Grouped by Cycle)
        ...
        st.write("## Per Cycle Predictive Summary Table (Grouped by Cycle)")
