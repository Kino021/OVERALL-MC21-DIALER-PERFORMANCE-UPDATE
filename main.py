...
if uploaded_file is not None:
    ...
    if df.empty:
       ...
       # In the Combined Summary Table calculation
def calculate_combined_summary(df):
    summary_table = pd.DataFrame(columns=[ 
        'Day', 'ACCOUNTS', 'TOTAL DIALED', 'PENETRATION RATE (%)', 'CONNECTED #', 
        'CONNECTED RATE (%)', 'CONNECTED ACC', 'PTP ACC', 'PTP RATE', 'CALL DROP #', 
        'SYSTEM DROP', 'CALL DROP RATIO #', 'TOTAL PTP AMOUNT'
    ]) 
...
# Repeat similar changes in other summary calculation functions
# For Predictive Summary Table
...
# Similarly, update the manual summary and per-cycle summary tables as well.

# Example for per-cycle predictive summary table
