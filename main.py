...
if uploaded_file is not None:
    ...
    if df.empty:
        ...
        # Calculate Overall Predictive Summary Table (same logic as Overall Combined but filtering for 'Predictive' and 'Follow Up')
        ...
        # Calculate Overall Manual Summary Table (same logic as Overall Combined but filtering for 'Outgoing' and without System Drop)
