...
if uploaded_file is not None:
    ...
    # You can add other sections as needed for the specific tables or summaries
    ...
    with col6:
        st.write("## Summary Table by Remark Type")
        for remark_type, remark_group in df.groupby('Remark Type'):
            st.write(f"Remark Type: {remark_type}")
            remark_type_summary = calculate_summary(remark_group, remark_type)
            st.write(remark_type_summary)
