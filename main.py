...
if uploaded_file is not None:
   ...
   def calculate_combined_summary(df):
    ...
    for date, group in df.groupby(df['Date'].dt.date):
        ...
        # Modified call drop count calculation based on 'Status' containing specific strings
        call_drop_count = group[group['Status'].str.contains('NEGATIVE CALLOUTS - DROP CALL|DROPPED', na=False)]['Account No.'].count()
